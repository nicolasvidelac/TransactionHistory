...
namespace WebApplication2.Controllers
{
    public class TransactionController : Controller
    {
        ...
        public async Task<IActionResult> AddOrEdit(int id, [Bind("TransactionId,AccounbtNumber,BeneficiaryName,BankName,SWIFTCode,Amount, Date")] TransactionModel transactionModel)
        {
